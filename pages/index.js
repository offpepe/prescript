...
export default function Home() {
  ...
  useEffect(() => {
    document.addEventListener('keyup', (ev) => ev.key === 'Escape' && setShowPrescript(false));
  }, [setShowPrescript]);
  ...
  return (
    <>
      ...
      <>
        ...
        <h4> Medicação </h4>
        <Button variant="dark" onClick={ () => setShow(true) }> Adicionar Receita   <FontAwesomeIcon icon={ faPlusCircle } /> </Button>
        </div>
